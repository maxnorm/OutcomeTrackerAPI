...
statcan_datasets = [
  {
    ...
    current_data: load_json("db/seeds/statcan_data/balance_sheets_quarterly.json")
  },
  {
    name: "consolidated-energy-statistics-monthly",
    ...
    last_synced_at: last_synced_at,
    current_data: load_json("db/seeds/statcan_data/consolidated_energy_statistics_monthly.json")
  },
  {
    name: "demographic-incomes-non-permanent-residents-annual",
    ...
    last_synced_at: last_synced_at,
    current_data: load_json("db/seeds/statcan_data/demographic_incomes_non_permanent_residents_annual.json")
  },
  {
    name: "gdp-quarterly",
    ...
    sync_schedule: "23 6 * * *", # Daily at 6:23 AM
    last_synced_at: last_synced_at,
    current_data: load_json("db/seeds/statcan_data/gdp_quarterly.json")
  },
  {
    ...
    sync_schedule: "23 6 * * *", # Daily at 6:23 AM
    last_synced_at: last_synced_at,
    current_data: load_json("db/seeds/statcan_data/housing_starts_monthly.json")
  },
  {
    name: "labour-productivity-quarterly",
    ...
    last_synced_at: last_synced_at,
    current_data: load_json("db/seeds/statcan_data/labour_productivity_quarterly.json")
  },
  {
    name: "non-permanent-residents-estimates-quarterly",
    ...
    last_synced_at: last_synced_at,
    current_data: load_json("db/seeds/statcan_data/non_permanent_residents_estimates_quarterly.json")
  },
  {
    ...
    sync_schedule: "23 6 * * *", # Daily at 6:23 AM
    last_synced_at: last_synced_at,
    current_data: load_json("db/seeds/statcan_data/population_estimates_quarterly.json")
  }
]
